...
wav_str2 = [
    dt.datetime.strftime(i, "7194.%y%m%d%H%M%S.wav") for i in wav_datetimes2[217:]
]
...
[
    os.rename(wav_files2[i], os.path.join(wav_folder[1], wav_str2[i]))
    for i in tqdm(range(len(wav_files2)))
]
