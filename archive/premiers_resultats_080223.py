...
FilePath = 'L:/acoustock/Bioacoustique/DATASETS/APOCADO/PECHEURS_2022_PECHDAUPHIR_APOCADO/Campagne 2/IROISE/335556632/analysis/C2D1_070722/Aplose results APOCADO_IROISE_C2D1_070722.csv'
# FilePath = 'L:/acoustock/Bioacoustique/DATASETS/APOCADO/PECHEURS_2022_PECHDAUPHIR_APOCADO/Campagne 2/IROISE/335556632/analysis/C2D1_070722/PG Binary/PG_formatteddata_220707_220708_10s.csv'
...
root = tk.Tk()
Tk().withdraw()
FilePath = filedialog.askopenfilename(title="Select APLOSE format detection file", filetypes=[("CSV files", "*.csv")])
from tkinter.filedialog import askdirectory
WavPath = askdirectory()
#%% User input
...
print('\nannotators :',annotators.reset_index(drop=True).to_string())

labels = df1['annotation'].drop_duplicates()
print('\nlabels :\n',labels.reset_index(drop=True).to_string())
print('\nlabels :\n',str(list(labels.reset_index(drop=True))))
