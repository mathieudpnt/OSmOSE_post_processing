...
raven_signal = (
    r"L:\acoustock2\Bioacoustique\HADOCC\ANALYSE\LTAS\signal_duty_cycle_OFF.ravensignal"
)
...
raven_ltas_csv = (
    r"L:\acoustock2\Bioacoustique\HADOCC\ANALYSE\LTAS\ltsa_duty_cycle_OFF.csv"
)
...
LTAS_deploy.plot_LTAS(dyn_min=30, dyn_max=90)
