...
lst_fichiers = sorted(glob.glob('L:/acoustock3/Bioacoustique/DATASETS/MIRACETI_ACOUSTIQUE/2017 concat/44100/*.wav'))
...
df_file = pd.DataFrame(index=range(len(lst_fichiers)), columns=['filename', 'dtstart', 'dtend', 'nbech', 'duration', 'cumsum', 'sample_rate'])
cumsum = 0
